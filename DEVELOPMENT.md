...
- `/manila` – Instagram ads landing page for Manila sessions with direct Cal.com booking CTA flow and Meta Pixel interactions (`ViewContent`, `LandingScrollDepth`, lead clicks).
