...
import BaliStickyCTA from '@/components/BaliStickyCTA'
        ...
        <div className="container space-y-12 sm:space-y-16">
          <div className="grid items-center gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8">
            <div className="order-1 flex flex-col items-center gap-8 lg:order-2 lg:items-end">
              ...
              <Link href="/#work" className="rounded-lg border-2 border-neutral-900 bg-neutral-900 px-6 py-2 text-sm font-semibold text-white transition hover:bg-neutral-800 self-start lg:self-end" data-cta="bali-portfolio">
                View Portfolio
              </Link>
            </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="rounded-3xl border border-accent/30 bg-accent/10 p-8">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <Link href="/#work" className="btn btn-primary px-6" data-cta="bali-portfolio">View Portfolio</Link>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-neutral-200 bg-white/80 p-8 shadow-sm">
            ...
            <p className="mt-6 text-xs text-neutral-500">
              Prefer email? Send a note to <a href="mailto:aidan@aidantorrence.com" className="underline">aidan@aidantorrence.com</a> with "Bali Session" in the subject.
            </p>
          </div>
          </div>
        </div>
