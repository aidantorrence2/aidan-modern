...
const collageImages = [
  { id: '000048780009', alt: 'Street portrait with neon wash at night', style: { top: '-6%', left: '-7%', width: '22%', transform: 'rotate(-2deg)' } },
  { id: '000023580035', alt: 'Film portrait framed by trailing light leaks', style: { top: '-4%', left: '15%', width: '22%', transform: 'rotate(1deg)' } },
  { id: '000032-8', alt: 'Candid portrait laughing off camera', style: { top: '-6%', left: '37%', width: '22%', transform: 'rotate(-1deg)' } },
  { id: 'aidantorre000579-000029', alt: 'Sunlit portrait with palm shadows', style: { top: '-4%', left: '59%', width: '22%', transform: 'rotate(2deg)' } },
  { id: '000041-6', alt: 'Golden-hour portrait with flare through hair', style: { top: '-6%', left: '81%', width: '22%', transform: 'rotate(-2deg)' } },
  { id: '000024-7', alt: 'Portrait surrounded by lush greenery', style: { top: '14%', left: '-9%', width: '22%', transform: 'rotate(1deg)' } },
  { id: 'aidantorre000579-000033', alt: 'Close portrait with cinematic shadow play', style: { top: '16%', left: '13%', width: '22%', transform: 'rotate(-1deg)' } },
  { id: '000048750032', alt: 'Portrait with bold color pop and motion blur', style: { top: '14%', left: '35%', width: '22%', transform: 'rotate(2deg)' } },
  { id: 'r1-05459-0015', alt: 'Twilight profile framed by city blur', style: { top: '16%', left: '57%', width: '22%', transform: 'rotate(-2deg)' } },
  { id: '000023-5', alt: 'Sun-drenched portrait with palms behind', style: { top: '14%', left: '79%', width: '22%', transform: 'rotate(-2deg)' } },
  { id: '000049660027', alt: 'Dramatic close-up with neon edge light', style: { top: '34%', left: '-7%', width: '22%', transform: 'rotate(-1deg)' } },
  { id: 'aidanto-r2-023-10', alt: 'Soft portrait with architectural geometry', style: { top: '36%', left: '15%', width: '22%', transform: 'rotate(2deg)' } },
  { id: '000040850004', alt: 'Moody film frame with smeared highlights', style: { top: '34%', left: '37%', width: '22%', transform: 'rotate(-2deg)', zIndex: 6 } },
  { id: '000010-3', alt: 'Window light portrait with reflective gaze', style: { top: '36%', left: '59%', width: '22%', transform: 'rotate(-2deg)' } },
  { id: '000027-6', alt: 'Portrait with architectural backdrop in shadow', style: { top: '34%', left: '81%', width: '22%', transform: 'rotate(1deg)' } },
  { id: '000034-4', alt: 'Editorial portrait with palms and sun flare', style: { top: '54%', left: '-9%', width: '22%', transform: 'rotate(2deg)' } },
  { id: '000031-6', alt: 'Ambient night portrait beneath street lamps', style: { top: '56%', left: '13%', width: '22%', transform: 'rotate(-2deg)' } },
  { id: 'r1-05457-0032', alt: 'Backlit portrait with foliage silhouettes', style: { top: '54%', left: '35%', width: '22%', transform: 'rotate(-2deg)' } },
  { id: '000040-5', alt: 'Soft focus portrait with color gel highlights', style: { top: '56%', left: '57%', width: '22%', transform: 'rotate(1deg)' } },
  { id: 'aidantorre000579-000023', alt: 'Center portrait with cinematic gaze', style: { top: '54%', left: '79%', width: '22%', transform: 'rotate(-1deg)' } },
  { id: '000048780013', alt: 'Vivid portrait with tropical foliage', style: { top: '74%', left: '-7%', width: '22%', transform: 'rotate(-2deg)' } },
  { id: '000023-3', alt: 'Candid rooftop portrait at dusk', style: { top: '76%', left: '15%', width: '22%', transform: 'rotate(-2deg)' } },
  { id: 'r1-05455-0020', alt: 'Evening portrait with city lights behind', style: { top: '74%', left: '37%', width: '22%', transform: 'rotate(1deg)' } },
  { id: '000049690037', alt: 'Film frame with cinematic bokeh', style: { top: '76%', left: '59%', width: '22%', transform: 'rotate(-1deg)' } },
  { id: '000049740026', alt: 'Sunset skyline portrait leaning on railing', style: { top: '74%', left: '81%', width: '22%', transform: 'rotate(2deg)' } }
]
        ...
        <div className="container grid items-center gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8">
          <div className="order-1 flex flex-col items-center gap-3 lg:order-2 lg:items-end">
            ...
            <div
              ...
              style={{ width: '155%', marginLeft: '-27%', marginTop: '-3%' }}
            >
