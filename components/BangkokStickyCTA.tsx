...
const WHATSAPP_MESSAGE = "Hey! Interested in the Bangkok shoot"

export default function BangkokStickyCTA(){
  ...
  function handleWhatsApp(event: React.MouseEvent<HTMLAnchorElement>){
    ...
    if (typeof window !== 'undefined' && (window as any).fbq) {
      (window as any).fbq('track', 'Lead', {
        content_name: 'Bangkok Photo Shoot',
      ...
      <div className="container flex flex-col gap-3 py-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          <a
            ...
            data-cta="bangkok-sticky-instagram"
          >
          ...
          <a
            ...
            data-cta="bangkok-sticky-whatsapp"
          >
            <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
