// Generated from libphonenumber-js metadata + Intl.DisplayNames (en). 245 regions.
...
export const COUNTRY_CODES: CountryCode[] = [
  ...
  { iso: "AG", name: "Antigua & Barbuda", dial: "+1", flag: "🇦🇬" },
  { iso: "AR", name: "Argentina", dial: "+54", flag: "🇦🇷" },
  { iso: "AM", name: "Armenia", dial: "+374", flag: "🇦🇲" },
  { iso: "AW", name: "Aruba", dial: "+297", flag: "🇦🇼" },
  { iso: "AC", name: "Ascension Island", dial: "+247", flag: "🇦🇨" },
  ...
  { iso: "HK", name: "Hong Kong SAR China", dial: "+852", flag: "🇭🇰" },
  ...
  { iso: "MO", name: "Macao SAR China", dial: "+853", flag: "🇲🇴" },
  ...
  { iso: "MM", name: "Myanmar (Burma)", dial: "+95", flag: "🇲🇲" },
  ...
  { iso: "PS", name: "Palestinian Territories", dial: "+970", flag: "🇵🇸" },
  ...
  { iso: "BL", name: "St. Barthélemy", dial: "+590", flag: "🇧🇱" },
  { iso: "SH", name: "St. Helena", dial: "+290", flag: "🇸🇭" },
  { iso: "KN", name: "St. Kitts & Nevis", dial: "+1", flag: "🇰🇳" },
  { iso: "LC", name: "St. Lucia", dial: "+1", flag: "🇱🇨" },
  { iso: "MF", name: "St. Martin", dial: "+590", flag: "🇲🇫" },
  { iso: "PM", name: "St. Pierre & Miquelon", dial: "+508", flag: "🇵🇲" },
  { iso: "VC", name: "St. Vincent & Grenadines", dial: "+1", flag: "🇻🇨" },
  { iso: "SD", name: "Sudan", dial: "+249", flag: "🇸🇩" },
  { iso: "SR", name: "Suriname", dial: "+597", flag: "🇸🇷" },
  { iso: "SJ", name: "Svalbard & Jan Mayen", dial: "+47", flag: "🇸🇯" },
  ...
  { iso: "WF", name: "Wallis & Futuna", dial: "+681", flag: "🇼🇫" },
