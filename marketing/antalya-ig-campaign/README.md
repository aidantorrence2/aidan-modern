...
Lineage: v1 portfolio photos (13 Sept), v2 six Pinterest pins (13 Sept, `render-pinterest-concept.mjs`, superseded), v3 seven full-res pins (14 Sept), v4 the three slide heroes replaced with pins from `public/images/pinterest/`, slide 3 titled "interested?" (15 Sept); v4b = same slides with a sign-up CTA (`--cta=signup` → `output-concept-v4b-signup/`) for the website ad. The export folder's `concept/` still holds v3 with a pointer file.
