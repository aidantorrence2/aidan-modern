...
const footer=txt('visual references · pinterest',64,1277,700,24);
const slides=[
 ['01-concept',txt('antalya / free photo collab',64,58,952,32)+txt('swimwear +<br>fashion editorial',64,126,980,78)+pic('15762667444508000',64,350,548,690)+pic('140806235144869',636,350,380,690)+txt('looking for people to shoot with',64,1100,952,50)+txt('dm if interested',64,1180,952,40)+footer],
 ['02-direction',txt('the mood',64,64,952,76)+txt('sea air. simple styling. beach light.',64,169,952,36)+pic('894879388481085674',64,270,470,650)+pic('1058205243703273898',558,270,458,480)+pic('17029304836389441',558,774,458,450)+txt('swimwear,<br>light layers,<br>your own style.',64,984,470,48)+footer],
 ['03-invitation',txt('into this kind<br>of shoot?',64,65,952,86)+pic('3025924747258283',64,330,530,770)+txt('free photo collab<br>in antalya',642,410,380,43)+txt('we plan the<br>styling, location<br>and date together.',642,620,380,36)+txt('dm if interested',64,1150,952,58)+txt('@madebyaidan',64,1230,952,28)+txt('visual reference · pinterest',642,1060,390,23)]
];
