    ...
    html: `
      <div style="width:1080px;height:1920px;position:relative;overflow:hidden;background:#000;">
        ...
        <div style="position:absolute;bottom:440px;left:64px;right:64px;">
          <h1 style="font-family:${SERIF};font-size:148px;font-weight:700;font-style:italic;color:white;line-height:0.88;margin:0;${S}">Antipolo</h1>
...
const slides = [
  hookSlide('antipolo-carousel-01-hook', imgUrban3, 'Want photos like these? No experience needed.'),
  proofSlide('antipolo-carousel-02-proof', 'My recent work', proof8),
  howSlideWarm('antipolo-carousel-03-how', 'Super simple.', steps, img0075),
  whatSlideDark('antipolo-carousel-04-what', 'All of this.<br/>For free.', deliverables, imgNight3),
  ctaSlide('antipolo-carousel-05-cta', imgIvy2, 'Your turn.', 'DM me to book your free photo shoot in Antipolo.'),
  signupSlide('antipolo-carousel-06-signup', 'Antipolo', imgIvy2)
]
