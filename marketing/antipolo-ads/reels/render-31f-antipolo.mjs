...
const OUT_DIR = path.join(__dirname, 'output-31f-antipolo')
...
function buildHTML(imageDataMap) {
  ...
  var titleWords = [
    { word: 'ANTIPOLO', color: TC.I, delay: 0.3 },
...
'        <div style="font-size:18px;font-weight:900;color:#00f0f0;letter-spacing:3px;text-shadow:0 0 12px rgba(0,240,240,0.5);">ANTIPOLO FREE PHOTO SHOOT</div>\n' +
'      </div>\n' +
...
async function render() {
  ...
  var dstVideo = path.join(OUT_DIR, 'antipolo-tetris-v31f.mp4')
  ...
  try {
    ...
    console.log('Rendered antipolo-tetris-v31f.mp4')
  } catch (err) {
  ...
  child_process.execSync('cp "' + dstVideo + '" "' + path.join(reelsDir, 'antipolo-tetris-v31f.mp4') + '"')
  console.log('Copied to reels/antipolo-tetris-v31f.mp4')
