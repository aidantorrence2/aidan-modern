...
//               "bring a friend. you both get photos." + Ahmedabad kicker
...
function L_hook(src) {
  ...
  const h1 = `<div style="position:absolute;bottom:350px;left:56px;right:56px;">
      ...
      <p style="font-family:${SE};font-size:58px;font-weight:700;font-style:italic;color:rgba(255,255,255,0.96);line-height:1.05;margin:18px 0 0;${SH}">you both get photos.</p>
    </div>`
...
async function render() {
  ...
  const dir = path.join(__dirname, 'output-ahmedabad-duo-v1b')
