...
const sets = {
  ...
  v15: { title: 'the moodboard', slides: [
    slide('01-callout', frame(box(190, line('let’s take<br>a trip.', 88)) + print(0, 90, 660, 440, 600, -5) + print(1, 590, 790, 340, 480, 4) + box(1400, line('looking for models in antalya', 50) + line('free photo collab', 44, 22, .85)))),
