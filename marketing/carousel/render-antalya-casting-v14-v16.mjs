...
const sets = {
  v14: { title: 'the invitation', slides: [
    ...
    slide('03-collab-cta', frame(box(240, line('let’s make it happen.', 72) + line('35mm film. free photo collab.<br>full-res scans in about 2 weeks.', 48, 50) + line('we choose the place, day + look together.', 42, 40, .85) + line('dm me “antalya” 🙂', 66, 65)) + print(3, 290, 920, 480, 570, -2) + handle(1570))),
  ]},
  v15: { title: 'the moodboard', slides: [
    ...
    slide('03-collab-cta', frame(box(200, line('your idea.<br>my camera.', 88) + line('free photo collab on 35mm film.<br>full-res scans in about 2 weeks.', 46, 45)) + print(0, 100, 780, 360, 500, -5) + print(1, 580, 850, 350, 490, 4) + box(1450, line('dm me “antalya” 🙂', 62) + line('we’ll plan the place + day together.', 40, 25, .85) + line('@madebyaidan', 38, 25, .8)))),
  ]},
  v16: { title: 'the photo essay', slides: [
    ...
    slide('03-collab-cta', full(3, box(1020, line('come shoot with me.', 72) + line('free photo collab on 35mm film.<br>full-res scans in about 2 weeks.', 44, 40) + line('dm me “antalya” 🙂', 62, 55) + line('let’s pick a place + day.', 44, 30) + line('@madebyaidan', 40, 30, .85)))),
  ]},
}
