...
// ANTALYA CASTING CALLOUT v1b — v1 with the dates removed and 'tfp collabs' → 'a free photo collab' (Aidan, 9/12).
// v1 was: clone of the final almaty callout
// (render-almaty-casting-claude-fable-5-1.mjs), city + dates swapped, nothing else.
// Black story frame, white typed text, informal: the ask in Aidan's own words
// (hi, i'm in antalya. / looking for models for tfp collabs sep 12-13 / dm me if interested / share).
// Dates = Antalya leg of the Turkey trip (land Fri 11 Sep 15:25, leave for Kaş Sun 13 Sep).
