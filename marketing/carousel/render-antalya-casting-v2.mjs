...
// ANTALYA CASTING CALLOUT v2 — the v1 single callout expanded to a 5-slide story set.
  ...
  slides.push({
    name: '03-what', html: frame(`
      <div style="position:absolute;top:220px;left:90px;right:90px;text-align:center;">
        ...
        ${line("free. it's tfp, so i post a few too", 50, 0.95, 44)}
      </div>
