...
// ATHENS STORY v2h — v2g with one swap:
...
const CITY = { name: 'Athens', slug: 'athens' }
  ...
  slides.push({
    name: '03-about', html: frame(`
      ...
      <div style="position:absolute;top:400px;left:120px;right:120px;text-align:center;">
        ...
        <p style="font-family:${SE};font-size:36px;color:rgba(255,255,255,0.94);line-height:1.42;margin:24px 0 0;">right now i'm in Greece, and i'm shooting in ${name}.</p>
