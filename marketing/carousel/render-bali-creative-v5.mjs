...
// 2-photo: split screen
function split2(nm,s1,s2,tg,headline){return {name:nm,html:'<div style="width:1080px;height:1920px;position:relative;overflow:hidden;background:#000;">'+img(s1,0,0,534,1920)+img(s2,546,0,534,1920)+'<div style="position:absolute;left:534px;top:0;width:12px;height:1920px;background:#000;"></div><div style="position:absolute;bottom:0;left:0;right:0;height:400px;background:linear-gradient(180deg, transparent, rgba(0,0,0,0.95));"></div><p style="position:absolute;bottom:260px;left:64px;font-family:'+SA+';font-size:20px;font-weight:700;color:rgba(255,255,255,0.5);letter-spacing:0.12em;text-transform:uppercase;margin:0;'+SH+'">'+tg+'</p><p style="position:absolute;bottom:140px;left:64px;right:64px;font-family:'+SE+';font-size:64px;font-weight:700;font-style:italic;color:white;line-height:0.95;margin:0;'+SH+'">'+headline+'</p>'+GR+'</div>'}}
// 2-photo: stacked diptych
function stacked(nm,s1,s2,text){return {name:nm,html:'<div style="width:1080px;height:1920px;position:relative;overflow:hidden;background:#0a0a0a;">'+img(s1,60,60,960,680,'object-position:center top;')+'<div style="position:absolute;left:0;top:740px;width:1080px;height:200px;background:#0a0a0a;display:flex;align-items:center;padding:0 64px;"><p style="font-family:'+SE+';font-size:52px;font-weight:700;font-style:italic;color:white;line-height:1.0;margin:0;'+SH+'">'+text+'</p></div>'+img(s2,60,940,960,680,'object-position:center top;')+'<p style="position:absolute;bottom:60px;left:64px;font-family:'+SA+';font-size:20px;font-weight:600;color:rgba(255,255,255,0.4);letter-spacing:0.1em;text-transform:uppercase;margin:0;'+SH+'">Shot on 35mm film \u00b7 @madebyaidan</p>'+GR+'</div>'}}
...
// 3-photo: warm paper with prints
function warm3(nm,tg,s1,s2,s3,subline){return {name:nm,html:warm(dtag(tg,64,50)+pr(s1,40,100,420,560,-3,14)+pr(s2,500,80,440,580,2.5,14)+pr(s3,180,700,660,500,1,16)+dh(subline,80))}}
// 1-photo: magazine spread
function magazine(nm,src,tg,headline,body,insetSrc){return {name:nm,html:'<div style="width:1080px;height:1920px;position:relative;overflow:hidden;background:#f5f0e6;">'+img(src,0,0,1080,1060,'object-position:center top;')+'<div style="position:absolute;left:0;top:1020px;width:1080px;height:900px;background:#f5f0e6;"></div><p style="position:absolute;left:64px;top:1060px;font-family:'+SA+';font-size:16px;font-weight:700;color:rgba(0,0,0,0.3);letter-spacing:0.15em;text-transform:uppercase;margin:0;">'+tg+'</p><p style="position:absolute;left:64px;top:1110px;right:64px;font-family:'+SE+';font-size:68px;font-weight:700;font-style:italic;color:#1a1a1a;line-height:0.95;margin:0;">'+headline+'</p><p style="position:absolute;left:64px;top:1380px;right:300px;font-family:'+SA+';font-size:26px;color:rgba(0,0,0,0.4);line-height:1.5;margin:0;">'+body+'</p><div style="position:absolute;right:40px;bottom:60px;width:220px;height:300px;background:white;padding:10px;transform:rotate(3deg);box-shadow:4px 4px 20px rgba(0,0,0,0.12);"><img src="'+insetSrc+'" style="width:200px;height:280px;object-fit:cover;object-position:center top;display:block;"/></div></div>'}}
