...
const variations = [
  ...
  { slug: 'v9', slides: [
    // Swap: h18 as hook hero, h13 as landscape frame on slide 2
    hookSlide(H.h18), // manila square — works as full bleed hero
    // Landscape photo contained in frame
    {name:'02',html:dark(tag('Shot on 35mm film',64,60)+'<div style="position:absolute;left:40px;top:120px;right:40px;height:640px;border-radius:12px;overflow:hidden;"><img src="'+H.h13+'" style="width:100%;height:100%;object-fit:cover;object-position:center;display:block;"/></div>'+h2('Models wanted<br/>in Bali.',200)+sub('TFP. All skill levels.',130))},
