...
const BASE_OUT = path.join(__dirname, 'output-bali-proof')
...
function heroBg(src, inner) {
  return '<div style="width:1080px;height:1920px;position:relative;overflow:hidden;background:#000;">'
    ...
    + '<div style="position:absolute;inset:0;background:linear-gradient(180deg, rgba(0,0,0,0.15) 0%, transparent 25%, transparent 50%, rgba(0,0,0,0.9) 100%);"></div>'
...
function heading(text, bottom, size, color) {
  size = size || 80; color = color || 'white'
...
function subtext(text, bottom, size) {
  size = size || 28
  return '<div style="position:absolute;bottom:'+bottom+'px;left:64px;right:64px;"><p style="font-family:'+SANS+';font-size:'+size+'px;color:rgba(255,255,255,0.45);margin:0;'+S+'">'+text+'</p></div>'
}

function tag(text, l, t) {
  return '<p style="position:absolute;left:'+l+'px;top:'+t+'px;font-family:'+SANS+';font-size:20px;font-weight:600;color:rgba(255,255,255,0.35);letter-spacing:0.12em;text-transform:uppercase;margin:0;'+S+'">'+text+'</p>'
}

function darkTag(text, l, t) {
  return '<p style="position:absolute;left:'+l+'px;top:'+t+'px;font-family:'+SANS+';font-size:20px;font-weight:600;color:rgba(0,0,0,0.3);letter-spacing:0.12em;text-transform:uppercase;margin:0;">'+text+'</p>'
}
...
variations.push({ slug: 'v1-work-speaks', slides: [
  ...
  { name: '02', html: darkBg(tag('Recent collaborations', 64, 50) + pr(p.a16, 60, 120, 600, 750, -1.5, 14) + pr(p.a13_3, 520, 680, 460, 580, 2.5) + pr(p.a01_8, 80, 1360, 400, 480, 3)) },
  ...
  { name: '09', html: heroBg(p.a10_11, heading('This could<br/>be you.', 440, 96) + subtext('DM me. I direct everything.', 380)) },
  { name: '10-cta', html: ctaBg(p.a07_3, heading('Let\u2019s<br/>collaborate.', 500, 100) + '<div style="position:absolute;bottom:380px;left:64px;right:64px;"><p style="font-family:'+SANS+';font-size:36px;color:rgba(255,255,255,0.9);margin:0;'+S+'">DM @madebyaidan on Instagram.</p><p style="font-family:'+SANS+';font-size:30px;color:rgba(255,255,255,0.5);margin:20px 0 0;'+S+'">Send me your look. I handle everything.</p></div>') },
]})
...
variations.push({ slug: 'v2-i-shoot-people', slides: [
  ...
  { name: '10-cta', html: ctaBg(p.a12, heading('DM me.', 500, 120) + '<div style="position:absolute;bottom:380px;left:64px;right:64px;"><p style="font-family:'+SANS+';font-size:36px;color:rgba(255,255,255,0.9);margin:0;'+S+'">@madebyaidan on Instagram.</p><p style="font-family:'+SANS+';font-size:30px;color:rgba(255,255,255,0.5);margin:20px 0 0;'+S+'">Collab spots open this month.</p></div>') },
]})
...
variations.push({ slug: 'v3-not-average', slides: [
  ...
  { name: '02', html: darkBg(tag('Recent work', 64, 50) + pr(p.a03, 80, 120, 560, 720, -2, 16) + pr(p.a14_3, 440, 660, 500, 640, 3)) },
...
variations.push({ slug: 'v4-casting-call', slides: [
  ...
  { name: '02', html: darkBg(pr(p.a16, 40, 80, 620, 800, -1, 16) + pr(p.a11_4, 520, 700, 480, 600, 3) + tag('Portfolio', 64, 50)) },
  ...
  { name: '10-cta', html: ctaBg(p.a05_3, heading('DM me.', 500, 120) + '<div style="position:absolute;bottom:380px;left:64px;right:64px;"><p style="font-family:'+SANS+';font-size:36px;color:rgba(255,255,255,0.9);margin:0;'+S+'">@madebyaidan on Instagram.</p><p style="font-family:'+SANS+';font-size:30px;color:rgba(255,255,255,0.5);margin:20px 0 0;'+S+'">Casting now. Limited spots.</p></div>') },
]})
...
variations.push({ slug: 'v6-you-me-bali', slides: [
  ...
  { name: '10-cta', html: ctaBg(p.a08_3, heading('DM me.', 500, 120) + '<div style="position:absolute;bottom:380px;left:64px;right:64px;"><p style="font-family:'+SANS+';font-size:36px;color:rgba(255,255,255,0.9);margin:0;'+S+'">@madebyaidan on Instagram.</p><p style="font-family:'+SANS+';font-size:30px;color:rgba(255,255,255,0.5);margin:20px 0 0;'+S+'">Send your look. Let\u2019s plan something.</p></div>') },
]})
...
variations.push({ slug: 'v7-proof-not-promises', slides: [
  ...
  { name: '10-cta', html: ctaBg(p.a15_3, heading('DM me.', 500, 120) + '<div style="position:absolute;bottom:380px;left:64px;right:64px;"><p style="font-family:'+SANS+';font-size:36px;color:rgba(255,255,255,0.9);margin:0;'+S+'">@madebyaidan on Instagram.</p><p style="font-family:'+SANS+';font-size:30px;color:rgba(255,255,255,0.5);margin:20px 0 0;'+S+'">Spots open now.</p></div>') },
]})
...
variations.push({ slug: 'v8-interesting-faces', slides: [
  ...
  { name: '06', html: heroBg(p.a01, subtext('Shot on film \u00b7 @madebyaidan', 420)) },
  ...
  { name: '10-cta', html: ctaBg(p.a14_3, heading('DM me.', 500, 120) + '<div style="position:absolute;bottom:380px;left:64px;right:64px;"><p style="font-family:'+SANS+';font-size:36px;color:rgba(255,255,255,0.9);margin:0;'+S+'">@madebyaidan on Instagram.</p><p style="font-family:'+SANS+';font-size:30px;color:rgba(255,255,255,0.5);margin:20px 0 0;'+S+'">Show me your face. I\u2019ll show you what I can do with it.</p></div>') },
]})
...
variations.push({ slug: 'v9-free-content', slides: [
  ...
  { name: '03', html: darkBg(pr(p.a42_5, 40, 60, 480, 620, -3) + pr(p.a05_3, 460, 40, 540, 680, 2) + pr(p.a41, 80, 720, 520, 660, 2) + pr(p.a15_3, 500, 740, 480, 600, -2.5) + tag('Recent collaborations', 64, 50)) },
  { name: '04', html: heroBg(p.a03, heading('I handle<br/>everything.', 440, 96) + subtext('Posing. Lighting. Location. Editing.', 380)) },
  { name: '05', html: darkBg(pr(p.a09, 60, 60, 560, 720, -1.5, 16) + pr(p.a14_3, 440, 580, 540, 680, 2.5) + subtext('Shot on 35mm film + digital.', 120)) },
