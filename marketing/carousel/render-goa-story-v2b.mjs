...
// GOA STORY v2b — clone of the final Udaipur story v2b set with:
//   - CITY = Goa
...
//   - about-me moved into the intentionally open 03 slot
//   - photographer image = aidan-udaipur-mirror-03.jpg (haveli mirror selfie, rounded)
// If the nepal files are missing, 04-nervous is skipped with a loud warning so
// the rest of the set can still be previewed.
const CITY = { name: 'Goa', slug: 'goa' }
...
const NEPAL_FILES = ['DSC_0242.jpg', 'DSC_0100.jpg', 'DSC_0248.jpg']
...
async function render() {
  if (!HAS_NEPAL) console.warn('WARNING: nepal-headliners missing from public/images — skipping 04-nervous.')
