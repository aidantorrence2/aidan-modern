...
// JAIPUR STORY v2b — base = render-story-v2.mjs (jaipur) with two slides transplanted
// from kolkata story v3e, inserted after 02-work:
//   03-morework: the v3e nepal film-print pile, retitled 'some of my work' -> 'some more of my work'
//   04-nervous:  the v3e 'never done this before?' nepal triptych (unchanged)
// Later slides renumbered (05-proof, 06-casting, 07-about, 08-how, 09-cta).
// Requires PortableSSD mounted (nepal headliners exports).
const CITY = { name: 'Jaipur', slug: 'jaipur' }
...
const NEPAL = '/Volumes/PortableSSD/Exports/nepal headliners'
...
function buildSlides({ name }) {
  ...
  // 03 — some MORE of my work: nepal film-print pile (transplanted from kolkata v3e 02-work; no white mat)
  {
  ...
  // 04 — never done this before? nepal staggered triptych (transplanted from kolkata v3e 05-proof)
  {
  ...
  // 07 — about me (trust/legitimacy; kept tight)
  slides.push({
