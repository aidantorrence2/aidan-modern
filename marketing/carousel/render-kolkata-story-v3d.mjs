...
function buildSlides({ name }) {
  ...
  {
    const f = [NP('DSC_0335.jpg'), NP('DSC_0333.jpg'), NP('DSC_0235.jpg'), NP('DSC_0408.jpg'), NP('DSC_0299.jpg')]
...
async function render() {
  ...
  const dir = path.join(__dirname, `output-${CITY.slug}-story-v3d`, CITY.slug)
