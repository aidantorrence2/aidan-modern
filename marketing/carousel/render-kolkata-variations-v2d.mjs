...
// === Kolkata carousel v2d — d-chat only ===
...
const OUT = path.join(__dirname, 'output-kolkata-variations-v2d')
...
// Four portrait prints — two top, two bottom, copy block in the middle (v2d slide 04).
function L_collage4(nm,a,b,d,e,c){return {name:nm,html:dark(
  pr(a,55,90,430,480,-2,12)+pr(b,545,120,430,480,2,12)
  +pr(d,55,1160,430,480,1.5,12)+pr(e,545,1130,430,480,-2,12)
  +copyMid(c,true))}}
...
function buildD(){
  ...
  return [
    ...
    L_collage4('04',p[1],p[2],p[3],p[4],{eyebrow:'Recent work', head:'This is how<br/>they turn out.', sub:'All shot on 35mm film, with zero prep from anyone.', headSz:84, pos:'mid'}),
