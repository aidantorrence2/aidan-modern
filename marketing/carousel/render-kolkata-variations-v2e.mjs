...
// === Kolkata carousel v2e — d-chat only ===
...
const OUT = path.join(__dirname, 'output-kolkata-variations-v2e')
...
function buildD(){
  ...
  return [
    ...
    L_collage4('04',p[1],p[2],p[3],p[4],{eyebrow:'Recent work', head:'the results', headSz:84, pos:'mid'}),
