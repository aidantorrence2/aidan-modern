...
// === Kolkata carousel v2h — d-chat only ===
...
const OUT = path.join(__dirname, 'output-kolkata-variations-v2h')
...
function buildD(){
  ...
  return [
    L_hook(p[0]),
    L_chat('02','&ldquo;Makeup?<br/>Posing?&rdquo;',[
    ...
    L_collage6('03',[p[1],p[2],p[3],p[4],p[5],p[6]],{eyebrow:'Recent work', head:'the results'}),
  ]
}
