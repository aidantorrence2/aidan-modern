...
// === Kolkata carousel v2i — d-chat only ===
...
const OUT = path.join(__dirname, 'output-kolkata-variations-v2i')
...
function buildD(){
  ...
  return [
    ...
    L_collage6('04',[p[1],p[7],p[3],p[4],p[8],p[9]],{eyebrow:'Recent work', head:'the results'}),
    ...
    L_close('06',nn('manila-gallery-ivy-002.jpg')),
  ]
}
