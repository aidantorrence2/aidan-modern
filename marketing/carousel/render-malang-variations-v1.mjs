...
const OUT = path.join(__dirname, 'output-malang-variations-v1')
...
const LOCATIONS=[
 // Variant A — highlands & gardens
 { slug:'a', title:'Malang', land:L1, off:0,
   hookH:'Malang<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Cool highlands. Sign up below.',
   s:[
    ['Highlands · 35mm','Tea fields. Mountain air. Film grain.'],
    ['Golden hour','Gardens at sunset. Real film.'],
    ['Highland Java on film<br/>hits different.','Mountain light. Real 35mm.'],
    ['Malang','Tea plantations.<br/>Flower gardens.<br/>Film.','Highland photo shoots on 35mm.'],
    ['Your face.<br/>Cool light.<br/>Real film.','Free collab. I direct everything. Tea fields, flower gardens, mountain air — your choice.'],
    ['Malang','Misty hills.<br/>Garden light.','Film loves cool highland light.'],
    ['Garden<br/>portraits.','Flowers. Tea fields. Soft light.'],
    ['Malang','This could<br/>be you.','Sign up below. It is free.'],
   ]},
 // Variant B — colonial streets & rainbow village
 { slug:'b', title:'Malang', land:L2, off:13,
   hookH:'Malang<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Old colorful streets. Sign up below.',
   s:[
    ['Old town · 35mm','Dutch facades. Color walls. Film grain.'],
    ['Golden hour','Colorful village at sunset. Real film.'],
    ['Old Malang on film<br/>hits different.','Street light. Real 35mm.'],
    ['Malang','Colonial streets.<br/>Jodipan color.<br/>Film.','Street photo shoots on 35mm.'],
    ['Your face.<br/>City light.<br/>Real film.','Free collab. I direct everything. Colonial streets, the rainbow village, old cafés — your choice.'],
    ['Malang','Painted walls.<br/>Old arches.','Film loves color.'],
    ['Street<br/>portraits.','Brick. Color. Golden hour.'],
    ['Malang','This could<br/>be you.','Sign up below. It is free.'],
   ]},
 // Variant C — waterfalls & orchards (Batu)
 { slug:'c', title:'Malang', land:L1, off:26,
   hookH:'Malang<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Waterfalls & orchards. Sign up below.',
   s:[
    ['Nature · 35mm','Waterfalls. Apple orchards. Film grain.'],
    ['Golden hour','Orchards at sunset. Real film.'],
    ['Wild Java on film<br/>hits different.','Forest light. Real 35mm.'],
    ['Malang','Coban falls.<br/>Apple orchards.<br/>Film.','Nature photo shoots on 35mm.'],
    ['Your face.<br/>Green light.<br/>Real film.','Free collab. I direct everything. Waterfalls, apple orchards, pine forest — your choice.'],
    ['Malang','Falling water.<br/>Cool mist.','Film handles water better than digital.'],
    ['Nature<br/>portraits.','Waterfalls. Orchards. Pine shade.'],
    ['Malang','This could<br/>be you.','Sign up below. It is free.'],
   ]},
]
