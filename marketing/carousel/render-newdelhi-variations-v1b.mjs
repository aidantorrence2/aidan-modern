...
const OUT = path.join(__dirname, 'output-newdelhi-variations-v1b')
const NT = '/Users/aidantorrence/Documents/aidan-modern/public/images/nature'
const LG = '/Users/aidantorrence/Documents/aidan-modern/public/images/large'
fs.mkdirSync(OUT, { recursive: true })

function nn(f){
  const p = fs.existsSync(path.join(NT,f)) ? path.join(NT,f) : path.join(LG,f)
...
// === LOAD 42 NATURE PHOTOS (identical order to pokhara v1) ===
const P=[
