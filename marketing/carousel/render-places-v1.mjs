...
const OUT = path.join(__dirname, 'output-places-v1')
...
function buildVariant(C){
  ...
  return [
    ...
    L_hero('05',ph[6],C.title,C.s[3][0],C.s[3][1]),
    L_mag('06',ph[7],C.title+' · Nature',C.s[4][0],C.s[4][1],ph[8]),
    L_hero('07',ph[9],C.title,C.s[5][0],C.s[5][1]),
    L_single('08',ph[10],C.s[6][0],C.s[6][1]),
    L_hero('09',ph[(2)%11],C.title,C.s[7][0],C.s[7][1]),
    L_cta(ph[4]),
  ]
}
