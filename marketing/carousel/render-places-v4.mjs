...
const OUT = path.join(__dirname, 'output-places-v4')
...
function L_steps(nm,place){
  ...
  const inner=tag('How it works',64,110)
    ...
    +'<div style="position:absolute;left:64px;right:64px;bottom:150px;"><p style="font-family:'+SA+';font-size:24px;color:rgba(255,255,255,0.5);margin:0;line-height:1.4;'+SH+'">Why free? I’m building my '+place+' film portfolio — real shoots, real people.</p></div>'
