...
const OUT = path.join(__dirname, 'output-places-v6')
...
const LOCATIONS=[
 { slug:'kintamani', title:'Kintamani', land:L1, off:0,
   hookH:'Kintamani<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Mount Batur. Sign up below.',
   s:[
    ...
    ['Kintamani','Volcano views.<br/>Misty pines.<br/>Film.','Highland photo shoots on 35mm.'],
 ...
 { slug:'amed', title:'Amed', land:L2, off:5,
   hookH:'Amed<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Black sand coast. Sign up below.',
   s:[
    ...
    ['Amed','Black sand.<br/>Jukung boats.<br/>Film.','Coastal photo shoots on 35mm.'],
 ...
 { slug:'ubud', title:'Ubud', land:L1, off:10,
   hookH:'Ubud<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Rice fields & jungle. Sign up below.',
   s:[
    ...
    ['Ubud','Rice fields.<br/>Jungle paths.<br/>Film.','Jungle photo shoots on 35mm.'],
 ...
 { slug:'uluwatu', title:'Uluwatu', land:L2, off:15,
   hookH:'Uluwatu<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Clifftops & surf. Sign up below.',
   s:[
    ...
    ['Uluwatu','Limestone cliffs.<br/>Surf below.<br/>Film.','Clifftop photo shoots on 35mm.'],
 ...
 { slug:'banyuwangi', title:'Banyuwangi', land:L1, off:20,
   hookH:'Banyuwangi<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Ijen & savanna. Sign up below.',
   s:[
    ...
    ['Banyuwangi','Ijen crater.<br/>Open savanna.<br/>Film.','Wild-nature photo shoots on 35mm.'],
 ...
 { slug:'malang', title:'Malang', land:L2, off:25,
   hookH:'Malang<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Highlands & old streets. Sign up below.',
   s:[
    ...
    ['Malang','Flower gardens.<br/>Old streets.<br/>Film.','Highland photo shoots on 35mm.'],
 ...
 { slug:'yogyakarta', title:'Yogyakarta', land:L1, off:30,
   hookH:'Yogyakarta<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Temples & old city. Sign up below.',
   s:[
    ...
    ['Yogyakarta','Borobudur.<br/>Batik streets.<br/>Film.','Heritage photo shoots on 35mm.'],
 ...
 { slug:'jakarta', title:'Jakarta', land:L2, off:2,
   hookH:'Jakarta<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Skyline & old town. Sign up below.',
   s:[
    ...
    ['Jakarta','Kota Tua.<br/>City rooftops.<br/>Film.','City photo shoots on 35mm.'],
 ...
 { slug:'surabaya', title:'Surabaya', land:L1, off:35,
   hookH:'Surabaya<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Old town & skyline. Sign up below.',
   s:[
    ['East Java · 35mm','Old town. Red Bridge. Film grain.'],
    ['Golden hour','Rooftop sunset. Real film.'],
    ['The city on film<br/>hits different.','Urban light. Real 35mm.'],
    ['Surabaya','Kota Lama.<br/>Heritage streets.<br/>Film.','City photo shoots on 35mm.'],
    ['Your face.<br/>City light.<br/>Real film.','Free collab. I direct everything. Old colonial town, Arab quarter, rooftops, harbor light — your choice.'],
    ['Surabaya','Brick facades.<br/>Harbor light.','Film loves old streets.'],
    ['Street<br/>portraits.','Brick. Cafés. Golden hour.'],
    ['Surabaya','This could<br/>be you.','Sign up below. It is free.'],
   ]},
]
