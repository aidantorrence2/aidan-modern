...
const OUT = path.join(__dirname, 'output-pokhara-variations-v1')
...
const LOCATIONS=[
 // Variant A — Phewa Lake & lakeside
 { slug:'a', title:'Pokhara', land:L1, off:0,
   hookH:'Pokhara<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Lakeside golden hour. Sign up below.',
   s:[
    ['Phewa Lake · 35mm','Still water. Wooden boats. Film grain.'],
    ['Golden hour','Lakeside at sunset. Real film.'],
    ['Lake light on film<br/>hits different.','Reflections. Real 35mm.'],
    ['Pokhara','Phewa Lake.<br/>Painted boats.<br/>Film.','Lakeside photo shoots on 35mm.'],
    ['Your face.<br/>Lake light.<br/>Real film.','Free collab. I direct everything. Phewa shoreline, wooden boats, Tal Barahi temple — your choice.'],
    ['Pokhara','Calm water.<br/>Drifting boats.','Film loves soft lakeside light.'],
    ['Lakeside<br/>portraits.','Water. Boats. Warm dusk.'],
    ['Pokhara','This could<br/>be you.','Sign up below. It is free.'],
   ]},
 // Variant B — Annapurna & Fishtail (Sarangkot sunrise)
 { slug:'b', title:'Pokhara', land:L2, off:13,
   hookH:'Pokhara<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Himalayan backdrop. Sign up below.',
   s:[
    ['Sarangkot · 35mm','Mountain dawn. Cloud sea. Film grain.'],
    ['Golden hour','Fishtail at sunrise. Real film.'],
    ['Annapurna light on film<br/>hits different.','Snow peaks. Real 35mm.'],
    ['Pokhara','Sarangkot ridge.<br/>Machhapuchhre.<br/>Film.','Mountain-view photo shoots on 35mm.'],
    ['Your face.<br/>Peak light.<br/>Real film.','Free collab. I direct everything. Sarangkot sunrise, Fishtail backdrop, hill terraces — your choice.'],
    ['Pokhara','Snow peaks.<br/>Sea of cloud.','Film loves clear mountain light.'],
    ['Mountain<br/>portraits.','Ridges. Peaks. Soft dawn.'],
    ['Pokhara','This could<br/>be you.','Sign up below. It is free.'],
   ]},
 // Variant C — World Peace Pagoda, paragliding & old bazaar
 { slug:'c', title:'Pokhara', land:L1, off:26,
   hookH:'Pokhara<br/>free photo shoot.', hookS:'Free photo shoot on 35mm film.<br/>Pagoda & sky views. Sign up below.',
   s:[
    ['Hilltop · 35mm','Peace Pagoda. Wide skies. Film grain.'],
    ['Golden hour','Pagoda viewpoint at sunset. Real film.'],
    ['Pokhara skies on film<br/>hits different.','Open light. Real 35mm.'],
    ['Pokhara','Peace Pagoda.<br/>Old bazaar lanes.<br/>Film.','Hilltop photo shoots on 35mm.'],
    ['Your face.<br/>Open light.<br/>Real film.','Free collab. I direct everything. World Peace Pagoda, paragliding ridges, old bazaar — your choice.'],
    ['Pokhara','White pagoda.<br/>Endless sky.','Film loves warm hilltop light.'],
    ['Skyline<br/>portraits.','Pagoda. Ridges. Golden hour.'],
    ['Pokhara','This could<br/>be you.','Sign up below. It is free.'],
   ]},
]
