...
const OUT = path.join(__dirname, 'output-ubud-creative-v3')
...
const variations = [
  ...
  { slug: 'v1', slides: [
    ...
    L_hero('05', p24, 'Ubud', 'White dress.<br/>Ocean waves.<br/>Film.', 'Beach shoots on 35mm.'),
    L_mag('06', p39, 'Ubud \u00b7 Nature', 'Your face.<br/>Natural light.<br/>Real film.', 'Free collab. I direct everything. Rice fields, jungle, golden hour — your choice.', p36),
    L_hero('07', p20, 'Ubud', 'Beach. Waves.<br/>Flowing fabric.', 'Film captures movement better.'),
    L_single('08', p34, 'Jungle<br/>portraits.', 'Ivy. Greenery. Shade.'),
    L_hero('09', p37, 'Ubud', 'This could<br/>be you.', 'Sign up if you are interested in collaborating.'),
    L_cta(p25),
  ]},
  ...
  { slug: 'v2', slides: [
    ...
    L_mag('06', p33, 'Nature \u00b7 Film', 'Golden hour<br/>portraits<br/>in Ubud.', 'Rice fields, jungle paths, waterfalls. I direct everything. You just show up.', p40),
    L_duo('07', p04, p05, 'Nature \u00b7 Ubud', 'Ivy. Flowers. Natural light.'),
    L_hero('08', p32, 'Villa', 'Morning sun.<br/>No flash.<br/>Just light.', 'Villa shoots in Ubud.'),
    L_hero('09', p07, 'Ubud', 'This could<br/>be you.', 'Sign up below.'),
    L_cta(p06),
  ]},
  ...
  { slug: 'v3', slides: [
    ...
    L_hero('09', p35, 'Ubud', 'This could<br/>be you.', 'Sign up if you are interested in collaborating.'),
    L_cta(p33),
  ]},
  // V4: 10 photos — hook(1) + warm3(3) + duo(2) + hero(1) + hero(1) + hero(1) + hero(1) = 10
  { slug: 'v4', slides: [
    L_hook(p36),  // blonde garden trees golden light
    L_warm3('02', 'Ubud \u00b7 35mm', p37, p38, p40, 'Forest. Grass.<br/>Golden hour.'),
    ...
    L_mag('05', p01, 'Ubud \u00b7 Nature', 'The best light<br/>in Bali<br/>is free.', 'Sunset. Rice fields. Jungle paths. I direct everything.', p34),
    ...
    L_hero('08', p23, 'Ubud', 'White dress.<br/>Ocean waves.', 'Beach shoots in Ubud.'),
    L_hero('09', p24, 'Ubud', 'This could<br/>be you.', 'Sign up below.'),
    L_cta(p20),
  ]},
]
