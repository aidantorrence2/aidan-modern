...
//   - 07-about photographer image = aidan-udaipur-mirror-01.jpg (haveli mirror selfie)
...
function buildSlides({ name }) {
  ...
  slides.push({
    name: '07-about', html: frame(`
      ...
      <img src="${Sf('aidan-udaipur-mirror-01.jpg')}" style="position:absolute;left:310px;top:880px;width:460px;height:580px;object-fit:cover;object-position:center top;display:block;border-radius:8px;"/>
    ` + grain(), '#0a0a0a')
  })
