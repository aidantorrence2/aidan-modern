...
const imgCanal1   = img('manila-gallery-canal-001.jpg')   // proof grid
const img0911     = img('manila-gallery-dsc-0911.jpg')    // proof grid
const imgMarket   = img('manila-gallery-market-001.jpg')  // proof bg + grid
...
// ════════════════════════════════════════════════════════════════════
//  SLIDE 1 — HOOK
//  Full-bleed hero. Massive stacked text: FREE / PHOTO SHOOT / Manila
// ════════════════════════════════════════════════════════════════════
const slide1 = {
  name: `${PREFIX}-01-hook`,
  html: `
    <div style="width:1080px;height:1920px;position:relative;overflow:hidden;background:#000;">
      ...
      <div style="position:absolute;bottom:360px;left:64px;right:64px;">
        <div style="font-family:${SERIF};font-size:180px;font-weight:700;font-style:italic;color:white;line-height:0.85;margin:0;${TS}">FREE</div>
        <div style="font-family:${SERIF};font-size:120px;font-weight:700;font-style:italic;color:white;line-height:0.9;margin:10px 0 0;${TS}">PHOTO SHOOT</div>
        <div style="font-family:${SANS};font-size:80px;font-weight:800;color:#FFD54F;line-height:1;margin:24px 0 0;letter-spacing:4px;text-transform:uppercase;${TS}">${CITY_UPPER}</div>
  ...
  html: `
    <div style="width:1080px;height:1920px;position:relative;overflow:hidden;background:#0a0a0a;">
      ...
      <div style="position:absolute;top:180px;left:0;right:0;text-align:center;z-index:3;">
        <h2 style="font-family:${SERIF};font-size:72px;font-weight:700;font-style:italic;color:white;margin:0;${TS}">My recent work</h2>
      </div>
      ${proofGrid}
      ${footerBadge()}
      ${filmGrain(0.06)}
  ...
  html: `
    <div style="width:1080px;height:1920px;position:relative;overflow:hidden;background:#000;">
      ...
      <div style="position:absolute;bottom:400px;left:64px;right:64px;">
        <div style="font-family:${SERIF};font-size:120px;font-weight:700;font-style:italic;color:white;line-height:0.95;margin:0;${TS}">Your turn.</div>
        <div style="font-family:${SANS};font-size:60px;font-weight:800;color:white;margin:36px 0 0;${TS}">DM @madebyaidan</div>
        <div style="font-family:${SANS};font-size:36px;color:rgba(255,255,255,0.75);margin:28px 0 0;${TS}">Free photo shoot in ${CITY}</div>
      </div>
      ${filmGrain(0.08)}
    </div>`
}
