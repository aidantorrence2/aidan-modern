...
const OUT_DIR = path.join(__dirname, "output-11a")
...
function slideFour(images) {
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${DARK_BG};">
      ...
      <!-- Neon urgency badge -->
      <div style="position:absolute;left:${SAFE_LEFT}px;top:660px;display:inline-flex;align-items:center;padding:16px 30px;border-radius:8px;border:2px solid ${NEON_PINK};box-shadow:${neonBoxGlow(NEON_PINK, 0.5)};background:rgba(255,45,123,0.08);">
