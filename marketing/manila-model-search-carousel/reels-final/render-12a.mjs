...
const OUT_DIR = path.join(__dirname, "output-12a")
...
function manilaHeader(top = SAFE_TOP, fontSize = 82) {
  const safeY = Math.max(top, SAFE_TOP)
  return `<p style="position:absolute;left:0;right:0;top:${safeY}px;text-align:center;
...
function slideOne(images) {
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;">
      ${surfaceBg()}
      ${manilaHeader(SAFE_TOP, 96)}

      <!-- subtitle -->
      <p style="position:absolute;left:0;right:0;top:${SAFE_TOP + 110}px;text-align:center;z-index:200;
...
function slideTwoAnimated(images) {
  ...
  const polaroids = [
    { src: images.scatterA, x: 66,  y: 400,  w: 340, h: 340, rot: -6,  caption: 'golden hour' },
    { src: images.scatterB, x: 520, y: 380,  w: 320, h: 320, rot: 4,   caption: 'street vibes' },
    { src: images.scatterC, x: 180, y: 700,  w: 360, h: 280, rot: 3,   caption: '' },
    { src: images.scatterD, x: 480, y: 670,  w: 300, h: 300, rot: -4,  caption: 'that look' },
    { src: images.scatterE, x: 80,  y: 960,  w: 380, h: 260, rot: 5,   caption: '' },
    { src: images.scatterF, x: 440, y: 930,  w: 340, h: 280, rot: -3,  caption: 'magic' },
    { src: images.scatterG, x: 220, y: 1180, w: 380, h: 260, rot: 2,   caption: 'Manila' },
  ]
  ...
  <html>
    ...
    <body>
      <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;">
        ...
        <!-- header -->
        <div class="header-text" style="position:absolute;left:0;right:0;top:${SAFE_TOP}px;z-index:200;text-align:center;">
...
function slideThree(images) {
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;">
      ${surfaceBg()}
      ${manilaHeader(SAFE_TOP, 82)}

      <p style="position:absolute;left:0;right:0;top:${SAFE_TOP + 105}px;text-align:center;z-index:200;
      ...
      <div style="position:absolute;left:400px;top:440px;width:580px;z-index:20;">
      ...
      <div style="position:absolute;left:80px;top:770px;width:360px;z-index:20;">
      ...
      <div style="position:absolute;left:430px;top:1090px;width:560px;z-index:20;">
...
function slideFour(images) {
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;">
      ${surfaceBg()}
      ${manilaHeader(SAFE_TOP, 86)}

      <!-- main CTA polaroid -->
      ${polaroid({
        src: images.cta,
        x: 120, y: 360,
        photoW: 680, photoH: 700,
        rotation: 1.5,
        caption: 'this could be you',
        zIndex: 10,
        shadowSize: 28
      })}
      ${tapeStrip(380, 352, 110, 28, -5)}
