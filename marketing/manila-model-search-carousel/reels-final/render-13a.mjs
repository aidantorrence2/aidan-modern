...
const OUT_DIR = path.join(__dirname, "output-13a")
...
function slideOne(images) {
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${WHITE};">
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${SAFE_TOP + 180}px;width:200px;height:3px;background:${RED};"></div>

      <!-- "models wanted." small, precise -->
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${SAFE_TOP + 210}px;">
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;top:600px;width:${SAFE_RIGHT - SAFE_LEFT}px;height:${HEIGHT - 600 - SAFE_BOTTOM - 40}px;overflow:hidden;">
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;bottom:${SAFE_BOTTOM + 20}px;">
  ...
  <html>
    ...
    <body>
      <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${WHITE};">
        ...
        <!-- Header -->
        <div class="header" style="position:absolute;left:${SAFE_LEFT}px;top:${SAFE_TOP}px;right:${WIDTH - SAFE_RIGHT}px;">
...
function slideThree(images) {
  ...
  for (const step of steps) {
    stepsHtml += `
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${y}px;right:${WIDTH - SAFE_RIGHT}px;height:1px;background:${GRAY_LINE};"></div>
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${y + 20}px;">
        <p style="font-family:${MONO};font-size:16px;font-weight:400;color:${RED};margin:0;letter-spacing:0.06em;">${step.num}</p>
      </div>
      <div style="position:absolute;left:130px;top:${y + 16}px;right:${WIDTH - SAFE_RIGHT}px;">
  ...
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${WHITE};">
      ...
      <!-- Bottom rule -->
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${500 + steps.length * 160}px;right:${WIDTH - SAFE_RIGHT}px;height:1px;background:${GRAY_LINE};"></div>
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${photoTop + 10}px;">
...
function slideFour(images) {
  ...
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${WHITE};">
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${SAFE_TOP + 100}px;right:${WIDTH - SAFE_RIGHT}px;">
      ...
      <!-- Thin red rule -->
      <div style="position:absolute;left:${SAFE_LEFT}px;top:530px;width:160px;height:3px;background:${RED};"></div>

      <!-- Subtext -->
      <div style="position:absolute;left:${SAFE_LEFT}px;top:550px;">
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;bottom:${SAFE_BOTTOM + 20}px;right:${WIDTH - SAFE_RIGHT}px;height:4px;background:${RED};"></div>

      <!-- Small tag -->
      <div style="position:absolute;left:${SAFE_LEFT}px;bottom:${SAFE_BOTTOM + 40}px;">
...
async function render() {
  ...
  const selection = {
    ...
    gridF: 'manila-gallery-market-001.jpg',
