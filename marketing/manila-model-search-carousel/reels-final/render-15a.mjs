...
const OUT_DIR = path.join(__dirname, "output-15a")
...
function slideOne(images) {
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${BG};">
      ...
      <!-- Sub text -->
      <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:520px;">
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:620px;bottom:${SAFE_BOTTOM + 20}px;border:6px solid ${BORDER};overflow:hidden;">
  ...
  <html>
    ...
    <body>
      <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${BG};">
        ...
        <div class="header" style="position:absolute;left:${SAFE_LEFT}px;top:${SAFE_TOP}px;">
          <span style="font-family:${HEAD};font-size:52px;font-weight:900;letter-spacing:0.22em;color:${ACCENT};text-transform:uppercase;">MANILA</span>
        </div>
        <div class="header" style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:${SAFE_TOP + 75}px;">
...
function slideThree(images) {
  ...
  for (let i = 0; i < steps.length; i++) {
    ...
    const s = steps[i]
    stepsHtml += `
      <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:${y}px;">
        <!-- Big number -->
...
function slideFour(images) {
  ...
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${BG};">
      ...
      <!-- MANILA accent -->
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${IMG_BOTTOM + 40}px;">
        <span style="font-family:${HEAD};font-size:52px;font-weight:900;letter-spacing:0.22em;color:${ACCENT};text-transform:uppercase;">MANILA</span>
      </div>

      <!-- CTA headline -->
      <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:${IMG_BOTTOM + 115}px;">
      ...
      <!-- CTA sub -->
      <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:${IMG_BOTTOM + 310}px;">
      ...
      <!-- Urgency pill -->
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${IMG_BOTTOM + 395}px;display:inline-flex;align-items:center;padding:14px 28px;border:3px solid ${BORDER};background:${TEXT};">
