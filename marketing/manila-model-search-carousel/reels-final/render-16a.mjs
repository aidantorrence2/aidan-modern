...
const OUT_DIR = path.join(__dirname, "output-16a")
...
function slideThree(images) {
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:#0a0a0a;">
      ...
      <!-- steps -->
      <div style="position:absolute;left:${SAFE_LEFT}px;top:480px;width:540px;display:flex;flex-direction:column;gap:20px;">
...
function slideFour(images) {
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:#000;">
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;top:640px;display:inline-flex;align-items:center;padding:16px 28px;border-radius:16px;background:rgba(255,255,255,0.14);backdrop-filter:blur(16px);border:1px solid rgba(255,255,255,0.2);">
