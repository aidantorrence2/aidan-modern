...
const OUT_DIR = path.join(__dirname, "output-1a")
...
function sceneHookHtml(images) {
  return `
    <div id="scene-hook" style="position:absolute;inset:0;width:${WIDTH}px;height:${HEIGHT}px;overflow:hidden;background:#000;">
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${SAFE_TOP}px;right:${WIDTH - SAFE_RIGHT}px;opacity:0;animation:slideDown 0.7s ease-out 0.3s forwards;">
...
function sceneProofHtml(images) {
  ...
  return `
    <div id="scene-proof" style="position:absolute;inset:0;width:${WIDTH}px;height:${HEIGHT}px;overflow:hidden;background:#0a0a0a;">
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${SAFE_TOP}px;right:${WIDTH - SAFE_RIGHT}px;opacity:0;animation:slideDown 0.5s ease-out 0s forwards;">
...
function sceneStepsHtml(images) {
  return `
    <div id="scene-steps" style="position:absolute;inset:0;width:${WIDTH}px;height:${HEIGHT}px;overflow:hidden;background:#0a0a0a;">
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${SAFE_TOP}px;width:540px;opacity:0;animation:slideDown 0.5s ease-out 0s forwards;">
        <p style="font-family:${NARROW};font-size:72px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:${MANILA_COLOR};margin:0 0 12px;">Manila</p>
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${SAFE_TOP + 180}px;width:540px;display:flex;flex-direction:column;gap:22px;">
...
function sceneCtaHtml(images) {
  return `
    <div id="scene-cta" style="position:absolute;inset:0;width:${WIDTH}px;height:${HEIGHT}px;overflow:hidden;background:#000;">
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${SAFE_TOP + 380}px;display:inline-flex;align-items:center;gap:16px;padding:22px 36px;border-radius:20px;background:${MANILA_COLOR};box-shadow:0 8px 32px rgba(232,68,58,0.4);">
        <!-- DM icon (chat bubble) -->
      ...
      <div style="position:absolute;left:${SAFE_LEFT}px;top:${SAFE_TOP + 490}px;">
