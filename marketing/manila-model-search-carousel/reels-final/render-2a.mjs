...
const OUT_DIR = path.join(__dirname, "output-2a")
...
function buildHTML(imageDataMap) {
  ...
  const editPhotos = [
    { src: imageDataMap[PHOTOS[1]], x: SAFE_LEFT,  y: SAFE_TOP + 150, w: 470, h: 560 },
    { src: imageDataMap[PHOTOS[2]], x: SAFE_LEFT + 490, y: SAFE_TOP + 150, w: 470, h: 560 },
    { src: imageDataMap[PHOTOS[3]], x: SAFE_LEFT,  y: SAFE_TOP + 730, w: 300, h: 400 },
    { src: imageDataMap[PHOTOS[4]], x: SAFE_LEFT + 320, y: SAFE_TOP + 730, w: 300, h: 400 },
    { src: imageDataMap[PHOTOS[5]], x: SAFE_LEFT + 640, y: SAFE_TOP + 730, w: 300, h: 400 },
  ]
  ...
  <div class="page">
    <div class="scroller">
      ...
      <div class="section" style="background:${CREAM};">
        ...
        <!-- Top rule -->
        <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:${SAFE_TOP}px;height:1px;background:rgba(255,255,255,0.5);transform-origin:left;transform:scaleX(0);opacity:0;animation:ruleGrow 0.8s ease-out ${T.topRule}s forwards, fadeIn 0.3s ease-out ${T.topRule}s forwards;"></div>

        <!-- Issue info -->
        <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:${SAFE_TOP + 8}px;display:flex;justify-content:space-between;">
        ...
        <!-- MANILA masthead -->
        <div style="position:absolute;left:0;right:0;top:${SAFE_TOP + 40}px;text-align:center;">
        ...
        <!-- Rule below masthead -->
        <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:${SAFE_TOP + 190}px;height:1px;background:rgba(255,255,255,0.45);transform-origin:center;transform:scaleX(0);opacity:0;animation:ruleGrow 0.8s ease-out ${T.masthead + 0.3}s forwards, fadeIn 0.3s ease-out ${T.masthead + 0.3}s forwards;"></div>

        <!-- Cover lines -->
        <div style="position:absolute;left:${SAFE_LEFT}px;bottom:${SAFE_BOTTOM + 80}px;">
      ...
      <div class="section" style="background:${CREAM};">
        <!-- Header -->
        <div style="position:absolute;left:0;right:0;top:${SAFE_TOP}px;padding:0 ${SAFE_LEFT}px;">
      ...
      <div class="section" style="background:${CREAM};">
        <!-- MANILA header -->
        <div style="position:absolute;left:0;right:0;top:${SAFE_TOP}px;text-align:center;">
        ...
        <!-- Headline -->
        <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:${SAFE_TOP + 150}px;">
        ...
        <!-- Steps -->
        <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:${SAFE_TOP + 310}px;">
          <!-- Step 1 -->
        ...
        <!-- Pull quote -->
        <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:1050px;opacity:0;animation:fadeSlideUp 0.6s ease-out ${T.pullQuote}s forwards;">
        ...
        <!-- Accent image -->
        <div style="position:absolute;right:${WIDTH - SAFE_RIGHT}px;bottom:${SAFE_BOTTOM + 30}px;width:280px;height:340px;box-shadow:0 6px 24px rgba(0,0,0,0.1);opacity:0;animation:fadeSlideUp 0.6s ease-out ${T.pullQuote + 0.5}s forwards;">
      ...
      <div class="section" style="background:${NEAR_BLACK};">
        ...
        <!-- Top rule -->
        <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:${SAFE_TOP}px;height:1px;background:rgba(255,255,255,0.25);transform-origin:left;transform:scaleX(0);opacity:0;animation:ruleGrow 0.8s ease-out ${T.ctaTransition + 0.5}s forwards, fadeIn 0.3s ease-out ${T.ctaTransition + 0.5}s forwards;"></div>
        ...
        <!-- Rule below masthead -->
        <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:${SAFE_TOP + 160}px;height:1px;background:rgba(255,255,255,0.25);transform-origin:center;transform:scaleX(0);opacity:0;animation:ruleGrow 0.8s ease-out ${T.ctaTitle - 0.2}s forwards, fadeIn 0.3s ease-out ${T.ctaTitle - 0.2}s forwards;"></div>

        <!-- CTA content -->
        <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;top:${SAFE_TOP + 200}px;text-align:center;">
        ...
        <!-- Bottom info -->
        <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;bottom:${SAFE_BOTTOM + 20}px;display:flex;justify-content:space-between;align-items:center;opacity:0;animation:fadeIn 0.5s ease-out ${T.ctaBadge + 0.5}s forwards;">
        ...
        <!-- Bottom rule -->
        <div style="position:absolute;left:${SAFE_LEFT}px;right:${WIDTH - SAFE_RIGHT}px;bottom:${SAFE_BOTTOM + 10}px;height:1px;background:rgba(255,255,255,0.15);opacity:0;animation:fadeIn 0.3s ease-out ${T.ctaBadge + 0.5}s forwards;"></div>
      </div>
