...
const OUT_DIR = path.join(__dirname, "output-31e")
...
async function render() {
  ...
  writeSources({
    ...
    strategy: 'v31e — Photos drop like Tetris blocks, clean images (no borders), word-block title',
    safeBottomPixels: SAFE_BOTTOM,
    photos: PROOF_PHOTOS,
  })

  var browser = await chromium.launch()
  console.log('Recording Tetris-themed reel (v31e — falling photos + word blocks)...')
  ...
  var dstVideo = path.join(OUT_DIR, 'manila-tetris-v31e.mp4')
  ...
  try {
    ...
    console.log('Rendered manila-tetris-v31e.mp4')
  } catch (err) {
