...
const OUT_DIR = path.join(__dirname, "output-3c")
...
async function render() {
  ...
  fs.writeFileSync(
    ...
    JSON.stringify({ createdAt: new Date().toISOString(), strategy: 'v3c — ChatGPT UI with boosted header readability', images: selection }, null, 2)
  )
