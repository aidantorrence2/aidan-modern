...
const OUT_DIR = path.join(__dirname, "output-4a")
...
<div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:#000;">
  ...
  <div style="position:absolute;inset:0;">
    ...
    <div style="position:absolute;inset:0;animation:viewfinderUiFade ${TOTAL_DURATION}s linear forwards;z-index:10;">
      ...
      <div style="position:absolute;top:${SAFE_TOP}px;left:${SAFE_LEFT}px;width:80px;height:80px;border-top:3px solid rgba(255,255,255,0.8);border-left:3px solid rgba(255,255,255,0.8);"></div>
      <!-- Corner brackets — top right -->
      <div style="position:absolute;top:${SAFE_TOP}px;right:${WIDTH - SAFE_RIGHT}px;width:80px;height:80px;border-top:3px solid rgba(255,255,255,0.8);border-right:3px solid rgba(255,255,255,0.8);"></div>
      <!-- Corner brackets — bottom left -->
      <div style="position:absolute;bottom:${SAFE_BOTTOM + 180}px;left:${SAFE_LEFT}px;width:80px;height:80px;border-bottom:3px solid rgba(255,255,255,0.8);border-left:3px solid rgba(255,255,255,0.8);"></div>
      <!-- Corner brackets — bottom right -->
      <div style="position:absolute;bottom:${SAFE_BOTTOM + 180}px;right:${WIDTH - SAFE_RIGHT}px;width:80px;height:80px;border-bottom:3px solid rgba(255,255,255,0.8);border-right:3px solid rgba(255,255,255,0.8);"></div>
      ...
      <div style="position:absolute;top:${SAFE_TOP + 20}px;left:${SAFE_LEFT + 20}px;display:flex;align-items:center;gap:10px;">
      ...
      <div style="position:absolute;top:${SAFE_TOP + 10}px;right:${WIDTH - SAFE_RIGHT}px;text-align:right;">
