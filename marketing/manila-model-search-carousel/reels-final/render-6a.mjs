...
const OUT_DIR = path.join(__dirname, "output-6a")
...
function buildAnimatedHtml(images) {
  ...
  let stepsHtml = ''
  const STEP_Y_START = SAFE_TOP + 250
  const STEP_GAP = 250
...
<body>
  <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${BG_DARK};">
    ...
    <div class="hook-section">
      <!-- MANILA label -->
      <div class="hook-manila" style="position:absolute;left:${PAD}px;top:${SAFE_TOP}px;">
      ...
      <!-- Accent line -->
      <div class="hook-line" style="position:absolute;left:${PAD}px;top:${SAFE_TOP + 70}px;height:3px;background:${MANILA_COLOR};overflow:hidden;"></div>
      <!-- Headline -->
      <div class="hook-headline" style="position:absolute;left:${PAD}px;right:${PAD}px;top:${SAFE_TOP + 100}px;">
      ...
      <!-- Subhead -->
      <div class="hook-sub" style="position:absolute;left:${PAD}px;right:${PAD}px;top:${SAFE_TOP + 260}px;">
      ...
      <!-- Hero image -->
      <div class="hook-image" style="position:absolute;left:${PAD - 8}px;right:${PAD - 8}px;top:${SAFE_TOP + 400}px;bottom:${SAFE_BOTTOM + 20}px;border-radius:18px;overflow:hidden;box-shadow:0 16px 50px rgba(0,0,0,0.5);">
    ...
    <div class="proof-section">
      <div class="proof-header" style="position:absolute;left:${PAD}px;top:${SAFE_TOP}px;right:${PAD}px;">
        <span style="font-family:${SANS};font-size:52px;font-weight:700;letter-spacing:0.3em;color:${MANILA_COLOR};text-transform:uppercase;">MANILA</span>
    ...
    <div class="process-section">
      <div class="process-header" style="position:absolute;left:${PAD}px;top:${SAFE_TOP}px;right:${PAD}px;">
        <span style="font-family:${SANS};font-size:52px;font-weight:700;letter-spacing:0.3em;color:${MANILA_COLOR};text-transform:uppercase;">MANILA</span>
        <div style="width:80px;height:3px;background:${MANILA_COLOR};margin-top:16px;margin-bottom:22px;"></div>
    ...
    <div class="cta-section">
      <!-- Large image top -->
      <div class="cta-image" style="position:absolute;left:${PAD - 8}px;right:${PAD - 8}px;top:${SAFE_TOP}px;height:660px;border-radius:18px;overflow:hidden;box-shadow:0 16px 50px rgba(0,0,0,0.5);">
        <img src="${images.cta}" style="width:100%;height:100%;display:block;object-fit:cover;object-position:center 20%;" />
      </div>

      <!-- MANILA label -->
      <div class="cta-manila" style="position:absolute;left:${PAD}px;top:910px;">
        <span style="font-family:${SANS};font-size:52px;font-weight:700;letter-spacing:0.3em;color:${MANILA_COLOR};text-transform:uppercase;">MANILA</span>
      </div>
      <!-- Accent line -->
      <div class="cta-line" style="position:absolute;left:${PAD}px;top:978px;height:3px;background:${MANILA_COLOR};overflow:hidden;"></div>

      <!-- DM Headline -->
      <div class="cta-headline" style="position:absolute;left:${PAD}px;right:${PAD}px;top:1006px;">
      ...
      <!-- @madebyaidan handle -->
      <div class="cta-handle" style="position:absolute;left:${PAD}px;right:${PAD}px;top:1226px;">
