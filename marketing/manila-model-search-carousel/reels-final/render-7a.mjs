...
const OUT_DIR = path.join(__dirname, "output-7a")
...
<body>
  <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:#000;">
    ...
    <!-- Editorial header -->
    <div style="position:absolute;top:${SAFE_TOP}px;left:0;right:0;height:200px;z-index:50;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#000;">
    ...
    <!-- Phone frame -->
    <div style="position:absolute;top:${SAFE_TOP + 200}px;left:30px;right:30px;bottom:0;border-radius:24px 24px 0 0;overflow:hidden;z-index:5;border:2px solid rgba(255,255,255,0.1);border-bottom:none;">
