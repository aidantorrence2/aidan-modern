...
const OUT_DIR = path.join(__dirname, "output-84a")
  ...
  ">
    ...
    ">
      ...
      <p style="
        ...
        line-height:1.1;
      ">MODEL COLLAB</p>
      <div style="width:80px;height:3px;background:${BALI_COLOR};margin:28px auto;border-radius:2px;"></div>
      <p style="
        font-family:${SF};
        font-size:54px;
        font-weight:800;
        ...
        margin:0 0 24px;
        line-height:1.2;
      ">Click the link to sign up!</p>
      <div style="
        display:inline-block;
        background:${BALI_COLOR};
        border-radius:12px;
        padding:14px 32px;
      ">
        <span style="
...
async function render() {
  ...
  fs.writeFileSync(
    ...
    JSON.stringify({ createdAt: new Date().toISOString(), strategy: 'v84a — Bali model collab ChatGPT DM, no header, sign-up CTA', images: selection }, null, 2)
  )
  ...
  if (videoFiles.length === 0) {
    ...
    const dstVideo = path.join(OUT_DIR, '01_bali_dm_story.mp4')
