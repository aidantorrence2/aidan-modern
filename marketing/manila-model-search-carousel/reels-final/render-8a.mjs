...
const OUT_DIR = path.join(__dirname, "output-8a")
...
function slideTwoAnimated(images, imageSizes) {
  ...
  // Visible viewport
  const VISIBLE_TOP = SAFE_TOP + 130
  ...
  <html>
    ...
    <body>
      <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${FILM_BG};">
        ...
        <!-- Header -->
        <div class="header" style="position:absolute;left:0;right:0;top:${SAFE_TOP}px;text-align:center;z-index:10;">
