...
const OUT_DIR = path.join(__dirname, 'output-v10')
...
function slideOne(images) {
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:#efe6dc;">
      ...
      ${framed(images.hero, 'left:124px;top:674px;width:832px;height:914px;', 'cover')}
    </div>
  `
}
  ...
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:#efe6dc;">
      ...
      <div style="position:absolute;left:58px;top:148px;right:58px;padding:30px 32px;border-radius:32px;background:rgba(255,250,245,0.96);border:1px solid rgba(84,58,43,0.1);box-shadow:0 22px 48px rgba(84,58,43,0.08);">
        <h2 style="font-family:${DISPLAY};font-size:70px;font-weight:700;line-height:0.94;color:#241914;margin:0 0 14px;">Portfolio images.</h2>
        <p style="font-family:${SANS};font-size:29px;line-height:1.34;color:#5b4335;margin:0;">Examples from my portfolio so people can quickly see the look and quality.</p>
      </div>
      ${framed(images.keepOne, 'left:58px;top:430px;width:308px;height:420px;')}
      ${framed(images.keepTwo, 'left:386px;top:430px;width:308px;height:420px;')}
      ${framed(images.proofA, 'left:714px;top:430px;width:308px;height:420px;')}
      ${framed(images.proofB, 'left:58px;top:884px;width:472px;height:704px;')}
      ${framed(images.proofC, 'left:550px;top:884px;width:472px;height:704px;')}
    </div>
  `
}
...
function slideFive(images) {
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:#0f1721;">
      ...
      ${framed(images.ctaMain, 'left:124px;top:680px;width:832px;height:908px;', 'cover')}
    </div>
  `
}
