...
const OUT_DIR = path.join(__dirname, 'output-v19b')
...
function buildAnimatedPage(images) {
  ...
  for (let i = 0; i < steps.length; i++) {
    ...
    stepsHtml += `
      <div class="process-section" style="position:absolute;left:${PAD}px;right:${PAD}px;top:${y}px;opacity:0;animation:fadeSlideUp 0.5s ease-out ${delay}s forwards, sectionOut 0.4s ease-in ${PROCESS_OUT}s forwards;">
...
<html>
  ...
  <body>
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${BG};">
      ...
      <!-- ===== SECTION 1: HOOK ===== -->
      <!-- MANILA label -->
      <div class="hook-section" style="position:absolute;left:${PAD}px;top:80px;opacity:0;animation:fadeIn 0.5s ease-out ${HOOK_IN}s forwards, sectionOut 0.4s ease-in ${HOOK_OUT}s forwards;">
      ...
      <!-- Main headline -->
      <div class="hook-section" style="position:absolute;left:${PAD}px;right:${PAD}px;top:170px;opacity:0;animation:fadeSlideUp 0.5s ease-out ${HOOK_IN + 0.15}s forwards, sectionOut 0.4s ease-in ${HOOK_OUT}s forwards;">
      ...
      <!-- Sub text -->
      <div class="hook-section" style="position:absolute;left:${PAD}px;right:${PAD}px;top:460px;opacity:0;animation:fadeSlideUp 0.5s ease-out ${HOOK_IN + 0.3}s forwards, sectionOut 0.4s ease-in ${HOOK_OUT}s forwards;">
      ...
      <!-- Hero image -->
      <div class="hook-section" style="position:absolute;left:${PAD}px;right:${PAD}px;top:620px;bottom:${SAFE_BOTTOM + 20}px;overflow:hidden;opacity:0;animation:heroScale 0.7s ease-out ${HERO_IN}s forwards, sectionOut 0.4s ease-in ${HOOK_OUT}s forwards;">
        <img src="${images.hero}" style="width:100%;height:100%;display:block;object-fit:cover;object-position:center 15%;"/>
      </div>

      <!-- ===== SECTION 2: PROOF ===== -->
      <!-- Proof header -->
      <div class="proof-section" style="position:absolute;left:${PAD}px;top:80px;opacity:0;animation:fadeIn 0.4s ease-out ${PROOF_HDR_IN}s forwards, sectionOut 0.4s ease-in ${PROOF_OUT}s forwards;">
        <span style="font-family:${HEAD};font-size:60px;font-weight:900;letter-spacing:0.22em;color:${MANILA_COLOR};text-transform:uppercase;">MANILA</span>
      </div>
      <div class="proof-section" style="position:absolute;left:${PAD}px;right:${PAD}px;top:170px;opacity:0;animation:fadeSlideUp 0.4s ease-out ${PROOF_HDR_IN + 0.1}s forwards, sectionOut 0.4s ease-in ${PROOF_OUT}s forwards;">
      ...
      <!-- ===== SECTION 3: PROCESS ===== -->
      <!-- Process header -->
      <div class="process-section" style="position:absolute;left:${PAD}px;top:80px;opacity:0;animation:fadeIn 0.4s ease-out ${PROCESS_HDR_IN}s forwards, sectionOut 0.4s ease-in ${PROCESS_OUT}s forwards;">
        <span style="font-family:${HEAD};font-size:60px;font-weight:900;letter-spacing:0.22em;color:${MANILA_COLOR};text-transform:uppercase;">MANILA</span>
      </div>
      <div class="process-section" style="position:absolute;left:${PAD}px;right:${PAD}px;top:170px;opacity:0;animation:fadeSlideUp 0.4s ease-out ${PROCESS_HDR_IN + 0.1}s forwards, sectionOut 0.4s ease-in ${PROCESS_OUT}s forwards;">
      ...
      <div class="process-section" style="position:absolute;right:${PAD}px;bottom:${SAFE_BOTTOM + 30}px;width:340px;height:420px;overflow:hidden;opacity:0;animation:heroScale 0.6s ease-out ${PROCESS_STEPS_IN + 1.0}s forwards, sectionOut 0.4s ease-in ${PROCESS_OUT}s forwards;">
        <img src="${images.process}" style="width:100%;height:100%;display:block;object-fit:cover;object-position:center 20%;"/>
      </div>

      <!-- ===== SECTION 4: CTA ===== -->
      <!-- CTA hero image -->
      <div class="cta-section" style="position:absolute;left:${PAD}px;right:${PAD}px;top:80px;height:700px;overflow:hidden;opacity:0;animation:heroScale 0.6s ease-out ${CTA_IN}s forwards;">
        <img src="${images.cta}" style="width:100%;height:100%;display:block;object-fit:cover;object-position:center 20%;"/>
      </div>

      <!-- MANILA label -->
      <div class="cta-section" style="position:absolute;left:${PAD}px;top:820px;opacity:0;animation:fadeIn 0.4s ease-out ${CTA_IN + 0.2}s forwards;">
        <span style="font-family:${HEAD};font-size:60px;font-weight:900;letter-spacing:0.22em;color:${MANILA_COLOR};text-transform:uppercase;">MANILA</span>
      </div>

      <!-- CTA headline -->
      <div class="cta-section" style="position:absolute;left:${PAD}px;right:${PAD}px;top:910px;opacity:0;animation:fadeSlideUp 0.5s ease-out ${CTA_IN + 0.3}s forwards;">
      ...
      <!-- Instagram handle -->
      <div class="cta-section" style="position:absolute;left:${PAD}px;right:${PAD}px;top:1170px;opacity:0;animation:fadeSlideUp 0.5s ease-out ${CTA_IN + 0.5}s forwards;">
        <p style="font-family:${HEAD};font-size:44px;font-weight:700;color:${MANILA_COLOR};line-height:1.3;">@madebyaidan on Instagram</p>
      </div>

      <!-- Sub-CTA text -->
      <div class="cta-section" style="position:absolute;left:${PAD}px;right:${PAD}px;top:1250px;opacity:0;animation:fadeSlideUp 0.5s ease-out ${CTA_IN + 0.6}s forwards;">
      ...
      <!-- Urgency pill -->
      <div class="cta-section" style="position:absolute;left:${PAD}px;top:1350px;display:inline-flex;align-items:center;padding:18px 36px;background:${MANILA_COLOR};opacity:0;animation:fadeSlideUp 0.5s ease-out ${CTA_IN + 0.7}s forwards, ctaPulse 2s ease-in-out ${CTA_IN + 1.5}s infinite;">
