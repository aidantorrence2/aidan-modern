...
const OUT_DIR = path.join(__dirname, 'output-v21')
...
<body>
  <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${BG};">
    ...
    <div class="hero-image" style="position:absolute;left:72px;right:72px;top:560px;bottom:${SAFE_BOTTOM + 20}px;border-radius:16px;overflow:hidden;">
...
function slideThreeHtml(images) {
  ...
  for (let i = 0; i < steps.length; i++) {
    ...
    const s = steps[i]
    stepsHtml += `
      <div class="step-card" style="position:absolute;left:${PAD}px;right:${PAD}px;top:${y}px;padding:28px 34px;border-radius:16px;background:${CARD_BG};border:1px solid ${CARD_BORDER};opacity:0;transform:translateX(-60px);animation:slideIn 0.6s ease-out ${delay}s forwards;">
...
<body>
  <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${BG};">
    <!-- Header -->
    <div style="position:absolute;left:${PAD}px;top:100px;right:${PAD}px;">
...
<body>
  <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:${BG};">
    ...
    <div class="cta-image" style="position:absolute;left:72px;right:72px;top:620px;bottom:${SAFE_BOTTOM + 20}px;border-radius:16px;overflow:hidden;">
