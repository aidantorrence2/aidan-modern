...
const OUT_DIR = path.join(__dirname, 'output-v42c')
...
function buildAnimatedDM(images) {
  ...
  // Content height with 42px font, 54px avatars, 440x580 photos:
  // Messages ~90px each, photos ~640px each (580+margin+spacer), reacts ~56px
  // Pre-photo: ~1050px | Photos: 5×640 = 3200px | Post-photo: ~600px
  // Total: ~4850px + 500px padding = ~5350px
  // Visible area: 1920-150-410 = 1360px → max scroll ≈ 3990px
