...
const OUT_DIR = path.join(__dirname, 'output-v43b')
...
async function render() {
  ...
  fs.writeFileSync(
    ...
    JSON.stringify({ createdAt: new Date().toISOString(), strategy: 'v43b — ChatGPT UI animated conversation (alt copy)', images: selection }, null, 2)
  )
