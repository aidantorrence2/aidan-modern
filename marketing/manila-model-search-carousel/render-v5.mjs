...
const OUT_DIR = path.join(__dirname, 'output-v5')
...
function slideTwo(images) {
  return `
    <div style="width:${WIDTH}px;height:${HEIGHT}px;position:relative;overflow:hidden;background:#efe3d5;">
      ...
      ${safeShade()}
      <div style="position:absolute;left:56px;top:72px;width:420px;">
        ${pill('Photo Proof', true)}
        <h2 style="font-family:${DISPLAY};font-size:72px;font-weight:700;line-height:0.94;color:#2b1e17;margin:22px 0 18px;">Photo proof.</h2>
        <p style="font-family:${SANS};font-size:31px;line-height:1.34;color:#5b4335;margin:0;">Recent Manila images so you can see the actual look and quality.</p>
      </div>
      ...
      ${frameImage(images[2], 'left:56px;top:586px;width:456px;height:640px;')}
      ${frameImage(images[3], 'left:568px;top:586px;width:456px;height:640px;')}
      ${frameImage(images[1], 'left:56px;top:1280px;width:968px;height:260px;', 'cover')}
    </div>
  `
}
...
async function render() {
  ...
  const slides = [
    ...
    ['02_photo_proof_story.png', slideTwo(images)],
