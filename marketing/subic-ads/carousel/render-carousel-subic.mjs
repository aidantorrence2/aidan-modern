    ...
    html: `
      <div style="width:1080px;height:1920px;position:relative;overflow:hidden;background:#000;">
        ...
        <div style="position:absolute;bottom:440px;left:64px;right:64px;">
          <h1 style="font-family:${SERIF};font-size:148px;font-weight:700;font-style:italic;color:white;line-height:0.88;margin:0;${S}">Subic</h1>
...
const slides = [
  ...
  ctaSlide('subic-carousel-05-cta', imgIvy2, 'Your turn.', 'DM me to book your free photo shoot in Subic.')
]
