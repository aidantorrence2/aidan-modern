...
var OUT_DIR = path.join(__dirname, 'output-66e-subic');
...
<div id="root" class="page">
  ...
  <div class="strips-container" id="strips-container">
    ...
    <div class="photo-strip" id="strip-1" style="opacity:0;transform:translateY(${H + 200}px);">
      <div class="strip-header">SUBIC FREE PHOTO SHOOT</div>
      ...
      <div class="strip-footer">@madebyaidan • subic 2026</div>
    </div>
...
async function main() {
  console.log('=== Photo Booth Strip v66e-subic ===');
  resetOutputDir();
  ...
  var outputMp4 = path.join(OUT_DIR, '66e-photo-booth-subic.mp4');
  execSync(
  ...
  var reelsDest = path.join(reelsDir, '66e-photo-booth-subic.mp4');
